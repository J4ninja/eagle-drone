...
# Scripts.sh
stream.sh = main GStreamer pipeline. Waits for camera to become available then luacheds treams. Called by systemed on boo boot and allows only one process to hold camera at a time. 
